...
import { Shield, Mail, Lock, ArrowRight, Code2 } from "lucide-react";
    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4">
      ...
      >
        ...
        <p className="text-center text-sm text-text-muted mt-6">
          ...
          <Link href="/register" className="text-brand-light hover:text-brand-mid transition-colors font-medium">
            Sign up
          </Link>
        </p>
      </motion.div>
