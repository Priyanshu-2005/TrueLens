...
import { Shield, Mail, Lock, User, ArrowRight, Code2 } from "lucide-react";
      ...
      >
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-6">
            <Shield className="w-8 h-8 text-brand-mid" />
          ...
          <p className="text-text-muted text-sm mt-1">Start verifying content authenticity</p>
        </div>
        ...
        <p className="text-center text-sm text-text-muted mt-6">
          ...
          <Link href="/login" className="text-brand-light hover:text-brand-mid transition-colors font-medium">
            Sign in
          </Link>
        </p>
      </motion.div>
